...
import KanbanCalculator from "./Forms/KanbanCalculator";
import { TreeCalculator } from "@/components/formula/Forms/TreeCalculator";
    ...
    <div>
      ...
      {items.map((item) => (
        <div
          ...
          className={cx("rounded-md shadow mt-10", {
...
const data: FormulaItem[] = [
  ...
  },
  {
    title: "LTC Y LUC",
    description:
      "Métodos para encontrar la cantidad óptima de pedidos por LTC Y LUC",
  ...
  {
    title: "Kanban",
    description: "Calculo de Kanban",
    formulaComponent: KanbanFormula,
    Id: "Kanban",
    FormulaDialog: KanbanCalculator,
  },
  {
    title: "MRP",
    description: "Calculo de de las Graficas para componentes y productos",
    formulaComponent: TreeFormula,
    Id: "MRP",
    FormulaDialog: TreeCalculator,
  },
];
