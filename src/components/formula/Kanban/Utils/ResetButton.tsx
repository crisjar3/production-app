...
const ResetButton: React.FC<ChildProps> = ({onClickFromParent}) => {
    return (
        <Button
            onClick={onClickFromParent}
            className=" ml-2 inline-flex items-center justify-center p-5 text-base font-medium text-gray-500 rounded-lg bg-gray-50 hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
            <span className="w-full ml-1">Resetear Resultados</span>
            <svg
